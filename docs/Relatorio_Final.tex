...
A Figura \ref{fig:nyquist_p} apresenta o diagrama de Nyquist, confirmando a estabilidade (sem circundamentos do ponto -1).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/report_images/04b_nyquist_P.png}
    \caption{Diagrama de Nyquist do Controlador Proporcional}
    \label{fig:nyquist_p}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/report_images/14b_nyquist_LeadLag.png}
    \caption{Diagrama de Nyquist Final (Lead-Lag): Estabilidade garantida com robustez.}
    \label{fig:nyquist_leadlag}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../assets/report_images/15b_nyquist_PID.png}
    \caption{Diagrama de Nyquist do Controlador PID}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/report_images/16_robustness_PID_fixed.png}
    \caption{Robustez do Controlador PID (Note o erro nulo permanente)}
    \label{fig:robustness_pid}
\end{figure}

\section{Comparativo Final de Estabilidade}

Para finalizar a análise de estabilidade, a Figura \ref{fig:comparative_nyquist} apresenta a sobreposição dos diagramas de Nyquist das três principais estratégias (Proporcional, Lead-Lag e PID) em torno do ponto crítico (-1+j0).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../assets/report_images/18_comparative_nyquist.png}
    \caption{Comparativo de Margens de Estabilidade no Plano de Nyquist. Note como as soluções compensadas (Lead-Lag e PID) contornam o ponto crítico com maior margem de segurança que o Proporcional puro.}
    \label{fig:comparative_nyquist}
\end{figure}
